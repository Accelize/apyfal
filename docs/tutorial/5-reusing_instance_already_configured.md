# Tutorial 5 : ReUsing Accelerator instance

## Introduction

This tutorial will cover reusing an instance already configured by an other client and process a file.  Along the way it will introduce the various components that make up AcceleratorAPI, and give you a comprehensive understanding of how everything fits together.
