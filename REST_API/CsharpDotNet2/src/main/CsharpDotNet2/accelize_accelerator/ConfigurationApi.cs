...
namespace IO.Swagger.Api
{
    ...
    public interface IConfigurationApi
    {
        ...
        InlineResponse2001 ConfigurationCreate (string parameters, System.IO.Stream datafile);
        /// <summary>
        ...
        /// <returns>InlineResponse200Results</returns>
        InlineResponse200Results ConfigurationRead (int? id);
    }
    ...
    public class ConfigurationApi : IConfigurationApi
    {
        ...
        /// <param name="datafile">If needed, file to be processed by the accelerator.</param> 
        /// <returns>InlineResponse2001</returns>            
        public InlineResponse2001 ConfigurationCreate (string parameters, System.IO.Stream datafile)
        {
...
if (datafile != null) fileParams.Add("datafile", ApiClient.ParameterToFile("datafile", datafile));
        ...
        /// <param name="id">A unique integer value identifying this accelerator config.</param> 
        /// <returns>InlineResponse200Results</returns>            
        public InlineResponse200Results ConfigurationRead (int? id)
        {
            ...
            return (InlineResponse200Results) ApiClient.Deserialize(response.Content, typeof(InlineResponse200Results), response.Headers);
        }
