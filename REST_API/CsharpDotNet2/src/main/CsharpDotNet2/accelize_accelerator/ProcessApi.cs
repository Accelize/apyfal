...
namespace IO.Swagger.Api
{
    ...
    public interface IProcessApi
    {
        ...
        InlineResponse2003 ProcessCreate (string configuration, string parameters, System.IO.Stream datafile);
        /// <summary>
        /// /v1.0/process/{id}/ 
        /// </summary>
        ...
        InlineResponse2002 ProcessList (int? page);
        /// <summary>
    ...
    public class ProcessApi : IProcessApi
    {
        ...
        /// <param name="datafile">If needed, file to be processed by the accelerator.</param> 
        /// <returns>InlineResponse2003</returns>            
        public InlineResponse2003 ProcessCreate (string configuration, string parameters, System.IO.Stream datafile)
        {
...
if (datafile != null) fileParams.Add("datafile", ApiClient.ParameterToFile("datafile", datafile));
        ...
        public void ProcessDelete (int? id)
        {
            ...
            if (id == null) throw new ApiException(400, "Missing required parameter 'id' when calling ProcessDelete");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ProcessDelete: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ProcessDelete: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="page">A page number within the paginated result set.</param> 
        /// <returns>InlineResponse2002</returns>            
        public InlineResponse2002 ProcessList (int? page)
        {
