...
export class ProcessApi {
     ...
     */
    public processCreate (configuration: string, parameters?: string, datafile?: any, extraHttpRequestParams?: any ) : Observable<models.InlineResponse2003> {
     ...
     */
    public processDelete (id: number, extraHttpRequestParams?: any ) : Observable<{}> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling processDelete.');
        }
        let requestOptions: RequestOptionsArgs = {
            method: 'DELETE',
            headers: headerParams,
     ...
     */
    public processList (page?: number, extraHttpRequestParams?: any ) : Observable<models.InlineResponse2002> {
        const path = this.basePath + '/v1.0/process/';
