...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AccelizeAcceleratorWs.InlineResponse2003Results = factory(root.AccelizeAcceleratorWs.ApiClient);
  }
  ...
  /**
   * The InlineResponse2003Results model module.
   * @module model/InlineResponse2003Results
   * @version 1.0
   */

  /**
   * Constructs a new <code>InlineResponse2003Results</code>.
   * @alias module:model/InlineResponse2003Results
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2003Results</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2003Results} obj Optional instance to populate.
   * @return {module:model/InlineResponse2003Results} The populated <code>InlineResponse2003Results</code> instance.
   */
