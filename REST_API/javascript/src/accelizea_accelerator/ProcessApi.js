...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2004', 'model/InlineResponse2003'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2004'), require('../model/InlineResponse2003'));
  } else {
    // Browser globals (root is window)
    if (!root.AccelizeAcceleratorWs) {
      root.AccelizeAcceleratorWs = {};
    }
    root.AccelizeAcceleratorWs.ProcessApi = factory(root.AccelizeAcceleratorWs.ApiClient, root.AccelizeAcceleratorWs.InlineResponse2004, root.AccelizeAcceleratorWs.InlineResponse2003);
  }
}(this, function(ApiClient, InlineResponse2004, InlineResponse2003) {
  'use strict';

  /**
   * Process service.
   * @module accelizea_accelerator/ProcessApi
   * @version 1.0
   */

  /**
   * Constructs a new ProcessApi. 
   * @alias module:accelizea_accelerator/ProcessApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:accelizea_accelerator/ProcessApi~processCreateCallback
     ...
     * @param {module:accelizea_accelerator/ProcessApi~processCreateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:accelizea_accelerator/ProcessApi~processListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:accelizea_accelerator/ProcessApi~processListCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:accelizea_accelerator/ProcessApi~processReadCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2004} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:accelizea_accelerator/ProcessApi~processReadCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2004}
     */
