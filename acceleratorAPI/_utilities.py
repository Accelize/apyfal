...
def gen_msg(message_id, *args):
    ...
    message = dict(
        ...
        created_failed="Failed to created %s",
        created_failed_named="Failed to created %s '%s'",
        accelize_generated="Generated by Accelize acceleratorAPI",
        attached_to="Attached %s '%s' to %s '%s'",
        authorized_ip="Authorized '%s' ports 22 and 80 in security group '%s'",
