...
Security: RAM Role and policy:
    By default, the ECS instance is configured to use a RAM role and policy
    generated by Apyfal on first instantiation.

    This give access in read and write to all OSS Buckets.
    This behavior can be changed by overriding RAM Role and/or policy.
    ...
    Apyfal create the default RAM rules and policy only if missing and will
...
class AlibabaCSP(_CSPHost):
    ...
    Args:
        ...
        policy (str): Alibaba RAM policy. Generated to allow instance to load
            FPGA bitstream and access to OSS. Default to 'AccelizePolicy'.
    ...
    POLICY_DOCUMENT = {"Version": "1", "Statement": [
        ...
        # Grant FPGA access
        # TODO: Copied from "faasPolicy", should be FAAS (aliyunsdkfaas)
    ...
    ASSUME_ROLE_POLICY_DOCUMENT = {"Version": "1", "Statement": [{
